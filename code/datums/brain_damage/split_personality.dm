...
/mob/living/split_personality/try_speak(message, ignore_spam, forced, filterproof, mute_bypass) // DOPPLER SHIFT EDIT CHANGE - Do Verb Refactor, ORIGINAL: /mob/living/split_personality/try_speak(message, ignore_spam, forced, filterproof)
