...
/// Trait for if the trait owner can pass through deep water without anything bad happening // DOPPLER EDIT ADDITION
#define TRAIT_DEEP_WATER_PASSER "ice_road_trucker" // DOPPLER EDIT ADDITION
