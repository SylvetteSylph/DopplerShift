...
#define SGROUP_DESERT_SAND S_TURF(100) // DOPPLER EDIT ADDITION
#define SGROUP_CRACKED_EARTH S_TURF(101) // DOPPLER EDIT ADDITION
#define SGROUP_ROCKY_SOIL S_TURF(102) // DOPPLER EDIT ADDITION
#define SGROUP_FANTASY_DIRT S_TURF(103) // DOPPLER EDIT ADDITION
#define SGROUP_FIRE_CLAY S_TURF(104) // DOPPLER EDIT ADDITION
#define SGROUP_FANTASY_GRASS S_TURF(105) // DOPPLER EDIT ADDITION

#define SGROUP_GRASS_MAT S_TURF(106) // DOPPLER EDIT ADDITION
#define SGROUP_REED_MAT S_TURF(107) // DOPPLER EDIT ADDITION

#define SGROUP_SHALLOW_WATER S_TURF(108) // DOPPLER EDIT ADDITION
#define SGROUP_DEEP_WATER S_TURF(109) // DOPPLER EDIT ADDITION
#define SGROUP_SWAMP_WATER S_TURF(110) // DOPPLER EDIT ADDITION

#define MAX_S_TURF 110 //Always match this value with the one above it. // DOPPLER EDIT - ORIGINAL - #define MAX_S_TURF 110
